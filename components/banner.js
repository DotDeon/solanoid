    ...
    <div className="bg-black mt-16  md:mt-[220px]">
      <div className="left-48 ">
        ...
        <div className="flex flex-row justify-start mt-16 ">
          <div className="cursor-pointer pr-4 md:pr-10 hover:scale-105 transform items-center transution duration-300 ease-out">
          ...
          <div className="cursor-pointer px-4  md:px-12 justify-center hover:scale-105 transform transution duration-300 ease-out">
            <Image src={yellow} height={304} width={304} />
            <h3 className="text-6xl text-center  font-bold font-Raleway mt-10 text-syellow">
              scarce
            </h3>
          </div>
          <div className="cursor-pointer  px-4 md:px-12  hover:scale-105 justify-center transform transution duration-300 ease-out">
